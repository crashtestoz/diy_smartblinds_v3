/*******************
 Created 1 May. 2020
  ...
  Tweaked for ESP32 by github.com/readeral
 *******************/
...
//IMPORTANT Make sure the pins are correctly connected
const int dirPIN = 16;
const int  stepPIN = 4;
...
int MAXSteps = 0; //Global variable for the maximum steps to open blinds = 100% open
...
int movesLeft = 0; //This holds the current remaining percent of move to make, this will be used in main loop to prevent blocking behaviour of the stepper function 
